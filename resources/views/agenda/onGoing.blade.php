        ...
        <div class="card">
          ...
          <div class="card-body">
			...
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link" href="{{ route('admin.'.$route.'.index').'?agenda=upComing' }}">Up Coming</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" href="{{ route('admin.'.$route.'.index').'?agenda=onGoing' }}">On Going</a>
				</li>
				<li class="nav-item">
