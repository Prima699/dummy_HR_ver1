        ...
        <div class="card">
          ...
          <div class="card-body">
			...
			<ul class="nav nav-tabs">
				...
				<li class="nav-item">
					<a class="nav-link active" href="{{ route('admin.agenda.index').'?agenda=done' }}">Done</a>
				</li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<div class="tab-pane container active" id="done">
...
@push('js')
	...
	<script src="{{ asset('public/js/agenda/done.js') }}"></script>
	<!--
	-->
@endpush