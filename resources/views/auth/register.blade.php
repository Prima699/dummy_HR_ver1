@extends('layouts.app', [
    ...
    'activePage' => 'register',
    'backgroundImage' => asset('public/'.'assets') . "/img/bg16.jpg",
])
        ...
        <div class="col-md-5 ml-auto">
          <div class="info-area info-horizontal mt-5">
            ...
            <div class="description">
              <h5 class="info-title">{{ ('Manage Employee') }}</h5>
              <p class="description">
                {{ ("We've created the app to manage employee data. It was a very interesting collaboration.") }}
              </p>
            </div>
          </div>
          <div class="info-area info-horizontal">
            ...
            <div class="description">
              <h5 class="info-title">{{ ('Employee Data') }}</h5>
              <p class="description">
                {{ ("We've Created, we've Read, we've U, we've Delete.") }}
              </p>
            </div>
          </div>
        </div>
