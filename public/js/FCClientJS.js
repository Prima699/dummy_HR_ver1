function FCClientJS(apiKey, apiSecret) {
	...
	this.facesDetect = function (urls, files, options, callback, _imgNo, id, field) {
		...
		CallMethod(method, files, params, callback, _imgNo, id, field);
		return true;
	};
	...
	this.facesRecognize = function (userIds, urls, files, options, callback, _imgNo, id, field) {
	...
	this.facesTrain = function (userIds, options, callback, _imgNo, id, field) {
		...
		CallMethod(method, null, params, callback, _imgNo, id, field);
		return true;
	};
	...
	this.tagsSave = function (tagIds, userId, options, callback, _imgNo, id, field) {
	...
	function isDefined(s) {
		return (typeof s != "undefined" && s != undefined);
	}

	function isEmpty(s) {
		return (!isDefined(s) || s == null || s == '');
	}
	...
	function CallMethod(method, files, params, callback, imgNo, id, field) {
