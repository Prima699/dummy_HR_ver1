$(document).ready(function() {
    $('#datatable').DataTable({
		"ajax" : digitasLink + "/api/espj/sp2d/data?a=" + $("#data").data("true"),
		"lengthChange" : false,
        "processing" : true,
        "serverSide" : true,
		"pageLength" : 10
	...
	function generateInfo(name,id){ // create button info
		var a = document.createElement("a");
			...
			$(a).attr("href",digitasLink + "/admin/sp2d/" + id);
	...
	function generateEdit(name,id){ // create button edit
		var a = document.createElement("a");
			...
			$(a).attr("href", digitasLink + "/admin/sp2d/edit/" + id);
	...
	function generateDelete(name,id){ // create button edit
		var a = document.createElement("a");
			...
			$(a).attr("href", digitasLink + "/admin/sp2d/delete/" + id);
	...
	function generateSignature(name,id){ // create button edit
		var a = document.createElement("a");
			...
			$(a).attr("href", digitasLink + "/admin/sp2d/sign/" + id);
